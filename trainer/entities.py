...
class Sentence:
    def __init__(self, sen_id: int, tokens: List[Token], entities: List[Entity], sentiments: List[Sentiment],
                 encoding: List[int],adj, pos_tokens):
        self._sen_id = sen_id
...
class Dataset(TorchDataset):
    ...
    def create_sentence(self, tokens, entity_mentions, sentiments, sen_encoding, adj, pos_tokens) -> Sentence:
        sentence = Sentence(self._sen_id, tokens, entity_mentions, sentiments, sen_encoding,adj, pos_tokens)
