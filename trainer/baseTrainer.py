...
class BaseTrainer:
    ...
    def __init__(self, args: argparse.Namespace):
        ...
        if hasattr(args, 'save_path'):
            self._save_path = self.args.save_path
    ...
    def _save_model(self, save_path: str, model: PreTrainedModel, tokenizer: PreTrainedTokenizer,
                    iteration: int, optimizer: optimizer = None, save_as_best: bool = True,
                    extra: dict = None, include_iteration: int = True, name: str = 'models'):
